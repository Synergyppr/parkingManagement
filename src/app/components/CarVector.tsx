...
const CarVector: React.FC<CarVectorProps> = ({
  ...
  return (
    <>
      {/* Responsive car-view labels */}
      <div
        className={`pointer-events-none absolute inset-0 z-20 ${
          hideLabels ? "select-none" : ""
        }`}
      >
        {/* Front View */}
        <button
          ...
          className={`pointer-events-auto absolute left-[8%] top-[3%] inline-flex max-w-[42%] items-center gap-1.5 rounded-full border border-(--primary-light) bg-white/95 px-2.5 py-1.5 text-[10px] font-extrabold leading-none text-primary shadow-sm backdrop-blur-sm transition sm:left-[10%] sm:top-[5%] sm:px-3 sm:py-2 sm:text-xs ${
            hideLabels
              ? "cursor-default opacity-80"
              : "cursor-pointer hover:-translate-y-0.5 hover:bg-primary hover:text-white hover:shadow-md"
          }`}
          aria-label="Open front view car parts"
        >
          <span className="truncate">Front View</span>

          {!hideLabels && <LuListVideo className="h-3.5 w-3.5 shrink-0" />}
        </button>
        ...
        <button
          ...
          className={`pointer-events-auto absolute right-[8%] top-[3%] inline-flex max-w-[42%] items-center gap-1.5 rounded-full border border-(--primary-light) bg-white/95 px-2.5 py-1.5 text-[10px] font-extrabold leading-none text-primary shadow-sm backdrop-blur-sm transition sm:right-[10%] sm:top-[5%] sm:px-3 sm:py-2 sm:text-xs ${
            hideLabels
              ? "cursor-default opacity-80"
              : "cursor-pointer hover:-translate-y-0.5 hover:bg-primary hover:text-white hover:shadow-md"
          }`}
          aria-label="Open rear view car parts"
        >
          {!hideLabels && <LuListVideo className="h-3.5 w-3.5 shrink-0" />}

          <span className="truncate">Rear View</span>
        </button>
        ...
        <button
          ...
          className={`pointer-events-auto absolute left-[3%] top-[43%] inline-flex max-w-[46%] -translate-y-1/2 items-center gap-1.5 rounded-full border border-(--primary-light) bg-white/95 px-2.5 py-1.5 text-[9px] font-extrabold leading-none text-primary shadow-sm backdrop-blur-sm transition sm:left-[5%] sm:max-w-[44%] sm:px-3 sm:py-2 sm:text-xs ${
            hideLabels
              ? "cursor-default opacity-80"
              : "cursor-pointer hover:-translate-y-[calc(50%+2px)] hover:bg-primary hover:text-white hover:shadow-md"
          }`}
          aria-label="Open passenger-side car parts"
        >
          <span className="truncate">
            {hideLabels ? "Passenger View" : "Passenger Side"}
          </span>
        ...
        <button
          ...
          className={`pointer-events-auto absolute bottom-[2%] right-[4%] inline-flex max-w-[46%] items-center gap-1.5 rounded-full border border-(--primary-light) bg-white/95 px-2.5 py-1.5 text-[9px] font-extrabold leading-none text-primary shadow-sm backdrop-blur-sm transition sm:bottom-[3%] sm:right-[6%] sm:max-w-[44%] sm:px-3 sm:py-2 sm:text-xs ${
            hideLabels
              ? "cursor-default opacity-80"
              : "cursor-pointer hover:-translate-y-0.5 hover:bg-primary hover:text-white hover:shadow-md"
          }`}
          aria-label="Open driver-side car parts"
        >
          {!hideLabels && <LuListVideo className="h-3.5 w-3.5 shrink-0" />}

          <span className="truncate">
            {hideLabels ? "Driver View" : "Driver Side"}
          </span>
        </button>
      </div>
      ...
      {!hideLabels && (
        <div className="mt-10 pt-12">
          ...
          >
            <button
              type="button"
              className={`inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl border px-4 text-sm font-extrabold transition sm:w-auto ${
                isReportAvailable
                  ? "cursor-pointer border-(--primary-light) bg-(--primary-soft) text-primary hover:bg-primary hover:text-white"
            ...
            <label
              className={`flex min-h-11 w-full items-center justify-center gap-2 rounded-xl border px-4 transition sm:w-auto ${
                isReportAvailable
                  ...
                  : "cursor-pointer border-(--primary-light) bg-white hover:bg-(--primary-soft)"
              }`}
            >
              <input
                type="checkbox"
              ...
              <span
                ...
                } peer-focus-visible:ring-4 peer-focus-visible:ring-(--primary-soft)`}
              >
                {noIncident && (
                  <svg
